...
export const ProductCardAuctionContainer1 = styled(ProductCardAuctionDefaultContent)`
    height: 435px;
...
export const ProductCardAuctionContainer2 = styled(ProductCardAuctionDefaultContent)`
    display: flex;
    width: 100%;
    height: 60px;
    padding: 20px;
...
export const ProductCardAuctionContent2 = styled(ProductCardAuctionDefaultContent)`
    display: flex;
    justify-content: space-between;
    align-items: center;
    width: 100%;
